...
const definitions = [
  ...
  {
    kind: 'projectorMapping',
    title: 'Projector Mapping',
    summary:
      'Draw a vertex quad on the frame and remap it with a planar projection.',
    domain: 'frame',
    category: 'image-processing',
    inputs: [port('source', 'Source', 'frame.rgba')],
    outputs: [port('frame', 'Frame', 'frame.rgba')],
    params: {
      x0: numberParam('Top-left X', 0.14, 0, 1, 0.01),
      y0: numberParam('Top-left Y', 0.2, 0, 1, 0.01),
      x1: numberParam('Top-right X', 0.86, 0, 1, 0.01),
      y1: numberParam('Top-right Y', 0.2, 0, 1, 0.01),
      x2: numberParam('Bottom-right X', 0.86, 0, 1, 0.01),
      y2: numberParam('Bottom-right Y', 0.8, 0, 1, 0.01),
      x3: numberParam('Bottom-left X', 0.14, 0, 1, 0.01),
      y3: numberParam('Bottom-left Y', 0.8, 0, 1, 0.01),
      offsetX: numberParam('Move X', 0, -0.5, 0.5, 0.01),
      offsetY: numberParam('Move Y', 0, -0.5, 0.5, 0.01),
      scale: numberParam('Scale', 1, 0.1, 3, 0.01),
      rotation: numberParam('Rotation', 0, -180, 180, 1),
      edgeMode: selectParam('Edges', 'transparent', [
        'transparent',
        'clamp',
    ...
    parameterLayout: {
      ...
      cornerXParams: ['x0', 'x1', 'x2', 'x3'],
      cornerYParams: ['y0', 'y1', 'y2', 'y3'],
      offsetXParamId: 'offsetX',
      offsetYParamId: 'offsetY',
      scaleParamId: 'scale',
      rotationParamId: 'rotation',
    },
  },
  {
    kind: 'warp',
